...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 px-6 bg-gradient-to-b from-black via-[#0a0a0a] to-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-16">
          <motion.h3
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-center font-audiowide text-2xl md:text-3xl font-bold text-white mb-12"
          >
            Meet Our <span className="text-[#63f8fc]">Organizing Team</span>
          </motion.h3>

          <div className="flex flex-wrap justify-center gap-8 max-w-7xl mx-auto mb-12">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="group relative bg-gradient-to-br from-black via-gray-900 to-black border border-[#63f8fc]/30 rounded-2xl p-8 overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-[#63f8fc]/20 transition-all duration-300 w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.5rem)] max-w-sm"
              >
                ...
                <div className="relative z-10 text-center mb-6">
                  <motion.div
                    ...
                    className="w-24 h-24 mx-auto rounded-full overflow-hidden border-2 border-[#63f8fc]/30 shadow-lg shadow-[#63f8fc]/20 mb-4 bg-gray-800"
                  >
                    <Image
                  ...
                  <h4 className="font-audiowide text-xl font-bold text-white group-hover:text-[#63f8fc] transition-colors duration-300">
                    {member.name}
                  </h4>
                  <p className="text-[#63f8fc] font-inter text-sm mt-1">{member.role}</p>
                </div>
                ...
                <div className="relative z-10 space-y-3">
                  ...
                  <motion.a
                    ...
                    whileHover={{ x: 5 }}
                    className="flex items-center space-x-3 text-gray-300 hover:text-[#63f8fc] transition-colors duration-300"
                  >
                    <div className="w-8 h-8 bg-[#63f8fc]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                      <svg className="w-4 h-4 text-[#63f8fc]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                    </div>
                    <span className="text-sm font-inter">{member.phone}</span>
                  </motion.a>
                  ...
                  >
                    ...
                    <span className="text-sm font-inter break-all">{member.email}</span>
                  </motion.a>
                  ...
                  >
                    <div className="w-8 h-8 bg-[#63f8fc]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                      <svg className="w-4 h-4 text-[#63f8fc]" fill="currentColor" viewBox="0 0 24 24">
