              ...
              >
                ...
                <div className="lg:hidden relative shrink-0 ml-2">
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="w-5 h-5 bg-[#63f8fc] rounded-full border-2 border-black shadow-lg shadow-[#63f8fc]/50">
                ...
                <div className={`w-full lg:w-[45%] ${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left'}`}>
                  <motion.div 
                    ...
                    className="group relative bg-gradient-to-br from-black via-gray-900 to-black border border-[#63f8fc]/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-[#63f8fc]/20 transition-all duration-300"
                  >
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 sm:mb-4 gap-3">
                      <div className={`flex items-center gap-2 sm:gap-3 ${index % 2 === 0 ? 'flex-row lg:flex-row-reverse' : 'flex-row'}`}>
                        <motion.div 
                          ...
                          className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-br from-[#63f8fc]/20 to-[#63f8fc]/5 rounded-lg sm:rounded-xl flex items-center justify-center text-2xl sm:text-3xl border border-[#63f8fc]/30 shadow-lg shadow-[#63f8fc]/10 shrink-0"
                        >
                          {event.icon}
                        </motion.div>
                    ...
                    <div className="relative z-10">
                      <h3 className="font-audiowide text-lg sm:text-xl md:text-2xl font-bold text-white mb-2 sm:mb-3 group-hover:text-[#63f8fc] transition-colors duration-300">
                        {event.title}
                      </h3>
